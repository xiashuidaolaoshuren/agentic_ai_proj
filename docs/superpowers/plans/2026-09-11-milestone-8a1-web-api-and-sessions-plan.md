...
- [ ] **Do:** Move `DigestStore` to `repositories/digest_store.py` and leave `storage.py` as a behavior-free re-export. Add the import-direction test. No schema or query change.
- **Blocked by:** —
- **Plan mode:** high
